  ...
  return (
    <footer className="container mx-auto text-lightGray py-12">
      <div className=" mx-auto px-4 md:px-0 flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <div className="mb-8 md:mb-0 md:mr-12 flex-1 text-left">
          ...
          <div className="flex space-x-4 mt-6">
            <a href="#" className="text-customWhite hover:text-green">
              <FaTwitter size={18} />
            </a>
            <a href="#" className="text-customWhite hover:text-green">
              <FaFacebook size={18} />
        ...
        <div className="flex-1 grid grid-cols-2 gap-8 mb-8 md:mb-0 text-left ">
          <div>
            <h3 className="text-customWhite font-semibold text-lg mb-2">
              Company
            </h3>
            <ul className="text-left">
              <li className="mb-2">
                <a
                  href="#"
                  className="text-gray hover:text-customWhite text-sm"
                >
                  Service
                </a>
              </li>
          ...
          <div>
            <h3 className="text-customWhite font-semibold text-lg mb-2 text-left">
              Help
            </h3>
            <ul>
              <li className="mb-2">
        ...
        <div className="flex-1 ">
          <h3 className="text-customWhite font-semibold text-lg mb-4 text-left">
      ...
      <div className="text-center text-gray text-sm mt-10">
        © Copyright 2024, All Rights Reserved by Ahmed Nabil
      </div>
    </footer>
  );
};
